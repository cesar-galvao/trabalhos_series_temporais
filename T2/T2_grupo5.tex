...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, sharp corners, breakable, frame hidden, interior hidden, enhanced, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
...
\toprule
\multicolumn{2}{c}{ } & \multicolumn{2}{c}{IC para 80\%} & \multicolumn{2}{c}{IC para 95\%} \\
